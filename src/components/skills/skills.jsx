...
const skills = () => {
  return (
    ...
    >
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 w-full gap-4">
                {category.skills.map((skill) => (
                  <div
                    key={skill.name}
                    className="flex flex-col items-center justify-center text-center break-words bg-transparent border-2 border-gray-700 rounded-3xl p-2 sm:p-3 w-full h-full"
                  >
                    <img
                      src={skill.logo}
                      alt={skill.name}
                    ...
                    />
                    <span className="text-xs sm:text-sm text-gray-300 font-semibold mt-1">
                      {skill.name}
                    </span>
                  </div>
                ))}
      ...
      {/* end of skills different categories */}
    </section>
  );
};
