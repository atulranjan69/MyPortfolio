...
const Work = () => {
  ...
  return (
    <section id="work" className="py-24 px-6 md:px-12 lg:px-20 font-sans bg-work-gradient">
            ...
            <div className='p-6'>
              ...
              <div className='flex justify-start gap-4'>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className='w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-400 px-6 py-2 rounded-xl text-lg font-semibold text-center'
                >
                  View Code
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className='w-1/2 bg-purple-800 hover:bg-purple-700 text-white px-7 py-2 rounded-xl text-lg font-semibold text-center'
                >
                  View Live
                </a>
              </div>
